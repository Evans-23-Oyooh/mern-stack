...
interface CarCardProps{
 ...
 const CarCard  = ({car}:CarCardProps) => {
  ...
  return (
    ...
    <CustormButton
    title='View More'
    containerStyles='w-full py-[16px] rounded-full bg-primary-blue' // Adjusted tailwind classes
    textStyles='text-white text-[14px] leading-[17px] font-bold' // Adjusted tailwind classes
    rightIcon='/right-arrow.svg' // Assuming this is the correct path to your icon
